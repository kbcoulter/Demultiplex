...
"""
PLEASE NOTE THIS SCRIPT USES A STANDARD FILE OPEN (not GZIP). TO PASS ZIPPED FILE, 
PLEASE ZCAT INTO A VAR AND THEN PASS THIS VAR INTO SCRIPT AS FILE. THIS WAS PROGRAMMED TO 
MAINTAIN SCRIPT FUNCTIONALITY WITH BOTH ZIPPED AND UNZIPPED FASTQ FILES.
"""
